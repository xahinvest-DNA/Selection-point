...
## 3. Связь с SP-S1-P05–SP-S1-P10

### SP-S1-P05 — доступность хода
...
### SP-S1-P06 — переживаемая неизбежность

Привычная толстая линия может переживаться не как один маршрут среди других, а как единственно существующее продолжение текущей позиции.
...
Параметр добавляет сравнение двух масштабов:
...
Боль возникает не в одной стрелке, а при обнаружении того, что последовательность локально необходимых ходов снова сформировала линию движения, расходящуюся со значимым направлением человека.

Граф не определяет за человека, какое направление является значимым. Заявленная цель может быть навязанной, устаревшей или не соответствовать реальным потребностям.
...
### SP-S1-P08 — реконструкция конкретного эпизода

При реконструкции одного эпизода граф помогает связать:
...
Модель не заменяет восстановление фактических условий, состояния, восприятия, образа себя и оперативной задачи. Она также не доказывает, что ретроспективно нарисованные линии были доступны человеку в реальном состоянии.


### SP-S1-P09 — телесное состояние внутри траектории

Телесное состояние входит в узел текущей позиции, может изменяться во время перехода и становится частью новой позиции:

```text
исходное телесное состояние
→ телесное разворачивание реакции
→ привычный ход
→ немедленное изменение состояния
→ отложенное телесное последствие
→ новая позиция и новое поле ходов
```

Граф не превращает телесный сигнал в диагноз, безошибочную истину или доказательство доступности любого альтернативного хода.


### SP-S1-P10 — текущая жизнь как позиция траектории

На масштабе повседневности узел включает материальные следы предыдущих переходов, включая состояние отношений:
...
### Значимое направление не равно любой цели

SP-S1-P07 не позволяет автоматически сравнивать траекторию с любой заявленной целью. Необходимо отличать собственное значимое направление от нормативного требования, чужого ожидания или устаревшего решения.

### Схема не используется для усиления боли

Граф не должен демонстрировать человеку «всю испорченную жизнь» или усиливать стыд ради мотивации. Он применяется только для точного различения конкретного механизма и доступной части участия на соответствующей фазе разработки практик.
...
- сравнения фактической траектории со значимым направлением;
...
> **Схема должна не демонстрировать человеку абстрактную свободу или усиливать боль, а помогать различать один конкретный механизм и доступную часть участия в формируемой траектории.**
