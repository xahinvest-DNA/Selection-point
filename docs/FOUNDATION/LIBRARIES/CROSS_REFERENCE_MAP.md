...
Следующие параметры нельзя выводить автоматически из первых восьми:
...
SP-S1-P09 не открыт до отдельного указания Андрея.
...
| SP-S1-P09 | не определяется до отдельного открытия параметра |
...
> SP-S1-P08 утверждён и зафиксирован. SP-S1-P09 не открыт до отдельного указания Андрея.
