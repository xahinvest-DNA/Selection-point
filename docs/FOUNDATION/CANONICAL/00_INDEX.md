...
11. `PARAMETER_CARD_TEMPLATE.md` — шаблон следующих параметров.
12. `DELIVERY_LAYER_RULES.md` — правила будущей сборки материалов доставки.
...
- SP-VM-01 связан с SP-HCM-09 и SP-S2-P01–SP-S2-P03 без создания новой визуальной модели;
- первая ступень содержательно завершена;
- во второй ступени утверждены первые три параметра;
- SP-S2-P04 не открыт.
