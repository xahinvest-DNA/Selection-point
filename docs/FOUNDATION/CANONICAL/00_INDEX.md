...
17. `PARAMETER_CARD_TEMPLATE.md` — шаблон следующих параметров.
18. `DELIVERY_LAYER_RULES.md` — правила будущей сборки материалов доставки.
...
## Актуальная связь SP-S2-P04–SP-S2-P09
...
SP-S2-P09 использует SP-VM-01 и SP-VM-02 без создания новой визуальной модели.
...
- SP-S2-P01–SP-S2-P09 канонизированы;
...
- во второй ступени утверждены первые девять параметров;
- SP-S2-P10 не открыт.
