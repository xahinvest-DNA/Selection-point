...
Проект находится в Фазе 3 — точной архитектуре пяти ступеней. SP-S1-P01–SP-S1-P08 утверждены, но SP-S1-P09 не открыт.
...
SP-S1-P09 не открыт. Codex не получает новую содержательную или техническую задачу до отдельного решения Андрея.
