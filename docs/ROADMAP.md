...
- параметры SP-S1-P01–SP-S1-P06 утверждены;
...
- риск объявления реальных ограничений только внутренней иллюзией;
- изменение поведения;
- безопасность;
- нагрузка;
- критерии перехода;
...
Продолжить Фазу 3 только с SP-S1-P07 первой ступени — «главная боль».
