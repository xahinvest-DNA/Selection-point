...
Stage 1 practice is not a daily exercise in explaining oneself.

It is repeated training of a short reality-coupled operation:
...
> “Observe all your automaticity today.”
...
- continuing alcohol use after the first drink;
...
- “Я уже налил следующую порцию.”
- “Возникло: ‘раз уже сорвал план, всё бессмысленно’.”
...
- old continuation delayed;
- action reduced;
- access changed;
- context changed;
- sequence stopped;
- support contacted;
- enough time/information created for an alternative.
...
REALIZE
Can I stop escalation, reduce consequence, repair, seek help,
change the next-cycle condition or consciously stop further action?

UPDATE
What is the new factual position?
~~~
...
> “Find the exact point where you should have chosen differently earlier.”
...
2. Can a retrieval cue be placed earlier?
3. Can one competing/replacement action be prepared?
4. Can the old route be made slightly less frictionless?
5. Only then rely on in-the-moment interruption if still needed.
~~~
...
No hidden-cause question is mandatory.
